...
class LetsMove : NSObject {
    ...
    fileprivate func PreferredInstallLocation() -> (URL?, Bool) {
        ...
        let userAppDirs = NSSearchPathForDirectoriesInDomains(.desktopDirectory, .userDomainMask, true)
        ...
        if appDir == nil {
            let localLocations = NSSearchPathForDirectoriesInDomains(.desktopDirectory, .userDomainMask, true)
